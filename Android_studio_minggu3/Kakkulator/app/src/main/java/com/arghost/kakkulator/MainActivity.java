package com.arghost.kakkulator;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void btnKurang(View view) {
        ...
        if (etBil_1.getText().toString().equals("") || etBil_2.getText().toString().equals("") ){
            Toast.makeText(this, "Nomor Tidak Ada", Toast.LENGTH_SHORT).show();
        }else {
    ...
    public void btnPerkalian(View view) {
        if (etBil_1.getText().toString().equals("") || etBil_2.getText().toString().equals("") ){
            Toast.makeText(this, "Ada Nomor Yang Kosong", Toast.LENGTH_SHORT).show();
        }else {
    ...
    public void btnPembagian(View view) {
        if (etBil_1.getText().toString().equals("") || etBil_2.getText().toString().equals("") ){
            Toast.makeText(this, "Nomor Harus Diisi", Toast.LENGTH_SHORT).show();
        }else {
