package com.arghost.konversisuhu;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void btnKonversi(View view) {
        ...
        if (etNilai.getText().toString().equals("")){
            Toast.makeText(this, "Nilai Tidak Boleh Bolong", Toast.LENGTH_SHORT).show();
        }else {
    ...
    public void rToC (){
        double suhu = Double.parseDouble(etNilai.getText().toString());
        double hasil = (5.0/4.0) * 100  ;
        tvHasil.setText(hasil+"");
    }
    public void rToF (){
        double suhu = Double.parseDouble(etNilai.getText().toString());
        double hasil = (9.0/4.0 * 100) + 32 ;
        tvHasil.setText(hasil+"");
    }
}